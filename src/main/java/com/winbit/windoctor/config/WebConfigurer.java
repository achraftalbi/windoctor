...
import com.winbit.windoctor.service.pdf.servlets.ServletPdf;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        servletContext.addServlet("ServletPdf"/*servlet name*/, ServletPdf.class /*servlet class*/);
        servletContext.getServletRegistration("ServletPdf" /*servlet name*/).addMapping("/servlet/ServletPdf" /*servlet path*/);
