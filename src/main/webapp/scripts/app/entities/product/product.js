    ...
    .config(function ($stateProvider) {
        $stateProvider
            .state('product', {
                ...
                data: {
                    roles: ['ROLE_DOCTOR'],
                    pageTitle: 'windoctorApp.product.home.title'
                },
                views: {
                    'content@': {
                ...
                ncyBreadcrumb: {
                    label: '<span class="fa fa-cubes" ></span>global.menu.entities.product'// angular-breadcrumb's configuration
                }
            ...
            .state('product.detail', {
                ...
                data: {
                    roles: ['ROLE_DOCTOR'],
                    pageTitle: 'windoctorApp.product.detail.title'
                },
                views: {
                    'content@': {
